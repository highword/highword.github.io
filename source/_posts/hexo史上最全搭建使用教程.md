---
title: hexo史上最全搭建使用教程
date: 2024-02-28 17:52:08
cover: https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/202509282047643.png
categories:
  - Computer Science
  - Others
tags:
...
## 背景
![image.png](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/202509281827511.png)

花了几天搭建了个网站，先上链接，欢迎来访：[Quasar的个人博客](https://giyanwei.github.io/)
...
[3. 安装Hexo](#3-安装hexo)
[4. GitHub创建个人仓库](#4-github创建个人仓库)
[5. 生成SSH添加到GitHub](#5-生成ssh添加到github)
[6. 将hexo部署到GitHub](#6-将hexo部署到github)
[7. 设置个人域名](#7-设置个人域名)
[8. 发布文章](#8-发布文章)
...
大概长这样：
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163258.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163340.png)

创建一个和你用户名相同的仓库，后面加.github.io，只有这样，将来要部署到GitHub page的时候，才会被识别，也就是xxxx.github.io，其中xxx就是你注册GitHub的用户名。我这里是已经建过了。
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163438.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163552.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163630.png)
...
点解析进去，添加解析。
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163911.png)


其中，192.30.252.153 和 192.30.252.154 是GitHub的服务器地址。
注意，解析线路选择默认，不要像我一样选境外。这个境外是后面来做国内外分流用的,在后面的博客中会讲到。记得现在选择默认！！
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229163936.png)


登录GitHub，进入之前创建的仓库，点击settings，设置Custom domain，输入你的域名fangzh.top
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229164007.png)


然后在你的博客文件source中创建一个名为CNAME文件，不要后缀。写上你的域名。
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229164045.png)
...
2. 更换主题
到这一步，如果你觉得默认的landscape主题不好看，那么可以在官网的主题中，选择你喜欢的一个主题进行修改就可以啦。[点这里](https://hexo.io/themes/)
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229170105.png)


这里有200多个主题可以选。不过最受欢迎的就是那么几个，比如[NexT主题](https://github.com/theme-next/hexo-theme-next)，非常的简洁好看，大多数人都选择这个，关于这个的教程也比较多。不过我选择的是[hueman](https://github.com/ppoffice/hexo-theme-hueman)这个主题，好像是从WordPress移植过来的。
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229170555.png)


也就是上传的是在本地目录里自动生成的.deploy_git里面。

其他文件 ，包括我们写在source 里面的，和配置文件，主题文件，都没有上传到github
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229170744.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229170941.png)


然后在这个仓库的settings中，选择默认分支为hexo分支（这样每次同步的时候就不用指定分支，比较方便）。
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229170954.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171045.png)
...
如图：
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171145.png)


6. 阿里云添加解析
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171304.png)
...
这里：
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171322.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171409.png)
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171459.png)
...
这里建议使用自动提交。
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229171533.png)
...
[来比力官网](https://livere.com/)，注册好后，点击管理页面，在代码管理中找到安装代码：
...
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229172028.png)


在存储中创建Class，命名为Counter,
![](https://mypersonaldata.oss-cn-shanghai.aliyuncs.com/img/20240229172047.png)
